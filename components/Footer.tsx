    ...
    <footer className="lei-footer">
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
            {logoUrl ? (
              ...
              <img src={logoUrl} alt={nome} className="lei-footer__logo" style={{ height: 70, width: 'auto', maxWidth: 280, objectFit: 'contain', marginLeft: -14 }} />
            ) : (
              <>
      ...
      <div className="lei-footer__bar">
        <div className="lei-wrap lei-footer__bar-inner">
          ...
          {/* Selo SSL oficial (Suporte Leilões) — imagem do template. */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className="lei-footer__ssl" src="/ssl-selo.png" width={109} height={38} alt="Site seguro — SSL e monitorado 24h" />
